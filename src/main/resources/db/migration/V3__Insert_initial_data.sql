INSERT INTO TB_USUARIO (id_usuario, nome_usuario, email_usuario, senha_usuario, role) VALUES (1, 'João Silva', 'joao@gmail.com', 'senha123', 'ADMIN');
INSERT INTO TB_USUARIO (id_usuario, nome_usuario, email_usuario, senha_usuario, role) VALUES (2, 'Maria Souza', 'maria@gmail.com', 'senha123', 'ADMIN');
INSERT INTO TB_USUARIO (id_usuario, nome_usuario, email_usuario, senha_usuario, role) VALUES (3, 'Carlos Lima', 'carlos@gmail.com', 'senha123', 'USER');
INSERT INTO TB_USUARIO (id_usuario, nome_usuario, email_usuario, senha_usuario, role) VALUES (4, 'Ana Costa', 'ana@gmail.com', 'senha123', 'USER');
INSERT INTO TB_USUARIO (id_usuario, nome_usuario, email_usuario, senha_usuario, role) VALUES (5, 'Fernanda Rocha', 'fernanda@gmail.com', 'senha123', 'USER');
